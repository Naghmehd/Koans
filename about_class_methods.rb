...
class AboutClassMethods < Neo::Koan
  ...
  def test_objects_have_methods ##can't understand this numbers are different
    fido = Dog.new
    assert fido.methods.size > 63
  end

  def test_classes_have_methods ##can't understand this numbers are different
    assert Dog.methods.size > 108
  end
